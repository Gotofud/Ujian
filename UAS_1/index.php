        ...
        <div class="container">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="row g-0">
                        <div class="col-sm-6 col-md-8"><h1 class="card-title">SISTEM PENGGAJIHAN GURU/KARYAWAN</h1> </div>
                        <div class="col-6 col-md-4 ms-auto"><div class="form-text mb-2">Sistem Penggajihan Guru/Karyawan Yayasan Assalaam Bandung.</div></div>
                    </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mx-auto" style="width:74rem; height:auto">
        <div class="card header py-1 bg-success text-white">
            <div class="row g-0 mt-3">
                <div class="col-sm-6 col-md-8"><h4 class="form-title mx-4">Data Penggajihan</h4></div>
                <div class="col-6 col-md-4"><div class="form-text text-white"><span class="text-danger">*</span> Isi Form dibawah ini untuk mengetahui gaji anda</div>
            </div>
        </div>
        </div>
        <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <input type="Number" class="form-control" id="exampleInputName1" name="cicilan"  placeholder="cicilan">
        </div>
            <div class="mb-3">
          <label for="exampleInputName1" class="form-label">Infaq</label>
          <input type="Number" class="form-control" id="exampleInputName1" name="infaq"  placeholder="Infaq">
        </div>
          </div>
        </div>
